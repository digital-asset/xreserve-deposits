import{M as x,ah as ae,R as c,C as de,c as $,r as L,a as w,i as y,x as d,n as l,y as W,A as _,D as u,e as ue,v as D,j as g,z as j,ac as he,V,E as U,O as R,s as F,f as pe,S as O,K as z,a9 as ee,T as me,U as ne,ai as fe}from"./index-CtiUCNcL.js";import"./index-BCKzUY-q.js";import{S as we}from"./SwapController-BEw7goTK.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},be=$`
  :host {
    display: block;
